...
$div_content.='<div class="row row_bill_items" id="bill_item_row'.$data_bill_items[$bill_item_index]['id'].'"><div class="medium-12 columns"><div class="medium-3 columns"><a href="#" class="bill_items" id="item_bill'.$data_bill_items[$bill_item_index]['item_id'].'" item_id="'.$data_bill_items[$bill_item_index]['item_id'].'" bill_item_id="'.$data_bill_items[$bill_item_index]['id'].'">'.$item_name[$data_bill_items[$bill_item_index]['item_id']].'</a></div><div class="medium-3 columns"><input type="text" value="'.$data_bill_items[$bill_item_index]['quantity'].'" class="item_quantity" id="item_quantity'.$data_bill_items[$bill_item_index]['item_id'].'" item_id="'.$data_bill_items[$bill_item_index]['item_id'].'" bill_item_id="'.$data_bill_items[$bill_item_index]['id'].'" /></div><div class="medium-2 columns"><a href="#" class="bill_items" id="item_rate'.$data_bill_items[$bill_item_index]['item_id'].'" item_id="'.$data_bill_items[$bill_item_index]['item_id'].'" bill_item_id="'.$data_bill_items[$bill_item_index]['id'].'">'.$data_bill_items[$bill_item_index]['rate'].'</a></div><div class="medium-2 columns"><a href="#" class="bill_item_cancel button tiny alert" id="item_cancel'.$data_bill_items[$bill_item_index]['item_id'].'" item_id="'.$data_bill_items[$bill_item_index]['item_id'].'" bill_item_id="'.$data_bill_items[$bill_item_index]['id'].'">X</a></div><div class="medium-2 columns"><a href="#" class="tiny  button parcel" id="parcel'.$data_bill_items[$bill_item_index]['item_id'].'" item_id="'.$data_bill_items[$bill_item_index]['item_id'].'" bill_item_id="'.$data_bill_items[$bill_item_index]['id'].'" select_id="bill_parcel"><strong>P</strong></a></div></div/></div/>';
}
$bill_item_index++;
